...
function HomeContent() {
  ...
  const copy = lang === 'ru' ? {
    ...
    about: 'О Марии',
    aboutText: 'Мария помогает клиентам улучшать питание, энергию, пищеварение и общее самочувствие через практичные, устойчивые и персональные рекомендации.',
    gut: 'Здоровье кишечника',
    weight: 'Контроль веса',
    hormones: 'Гормоны и энергия',
    family: 'Семейное питание',
    content: 'Закрытая библиотека',
    contentText: 'Участники получают доступ к статьям, рецептам, протоколам и материалам программы.',
    ...
    about: 'About Maria',
    aboutText: 'Maria helps clients improve nutrition, energy, digestion and wellbeing through practical, sustainable and personalised guidance.',
    gut: 'Gut Health',
